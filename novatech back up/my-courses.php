...
$stmt = $pdo->prepare("SELECT course_name, progress, lessons_remaining FROM enrollments WHERE user_id = :user_id");
$stmt->execute(['user_id' => $user_id]);
...
<head>
    ...
    <title>My Subjects - NovaTech FET College</title>
        ...
        <header class="bg-white shadow-md">
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <h1 class="text-xl font-bold text-navy">My Courses</h1>
        ...
        <main class="container mx-auto px-6 py-8">
            <div class="bg-white rounded-xl shadow-lg p-6 dashboard-card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="enroll.php" class="text-gold hover:underline">Enroll in New Course</a>
                </div>
                <?php if (empty($courses)): ?>
                    <p class="text-gray-600">You are not enrolled in any courses yet. <a href="enroll.php" class="text-gold hover:underline">Enroll now</a>.</p>
                <?php else: ?>
                        ...
                        <?php foreach ($courses as $index => $course): ?>
                            <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition">
                                ...
                                <p class="text-gray-600 text-sm mb-3">
                                    <?php echo $index % 2 == 0 ? 'Master algebra, calculus, and problem-solving techniques' : 'Physics and chemistry concepts for matric success'; ?>
                                </p>
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="course-content.php?course=<?php echo urlencode($course['course_name']); ?>" class="text-gold text-sm font-medium">Continue</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
